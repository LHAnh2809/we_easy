...
import 'work_item_cty_widget.dart';

class DetailedWorkPage extends GetView<HomeController> {
  final AllJobModel model;
  const DetailedWorkPage({Key? key, required this.model}) : super(key: key);
                ...
                children: [
                  ...
                  ListView(
                    children: [
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                          maxLines: 2,
                                          overflow: TextOverflow.ellipsis,
                                          model.businessAddress.toString(),
                      ...
                      Column(
                        children: controller.listAllJobCtyModel.map((model) {
                          String? formattedDateTime =
                              Utils.timestampToDateTime(model.date);
                          return WorkItemCtyWidget(
                            model: model,
